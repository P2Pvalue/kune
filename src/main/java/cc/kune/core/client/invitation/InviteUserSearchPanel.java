 ...
 */
@Singleton
public class InviteUserSearchPanel extends EntitySearchPanel {

  /**
   * Instantiates a new invite user search panel
   * 
   * @param img
   *          the image resource
   * @param i18n
   ...
   */
  @Inject
  public InviteUserSearchPanel(CoreResources img, I18nTranslationService i18n) {
    super(img, i18n);
  }
